<?php
/**
 * WP Godspeed functions and definitions
 *
...
function wpsharan_setup() {
	/*
		...
		* If you're building a theme based on WP Godspeed, use a find and replace
		* to change 'wp-godspeed' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'wp-godspeed', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'wp-godspeed' ),
		)
	);
...
function wpsharan_widgets_init() {
	register_sidebar(
		array(
			...
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'wp-godspeed' ),
...
function wpsharan_scripts() {
	...
	wp_enqueue_script( 'wp-godspeed-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
